  ...
  return (
    <>
      {showModal && (
        ...
        >
          {content === 'donate' ? (
            ...
            <>
              <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white dark:text-opacity-70" id="modal-headline">
                原 Qwerty Learner 的 VSCode 摸🐟插件
              </h3>
              <div className="mt-2 ">
                <p className="text-sm text-gray-500  dark:text-gray-400">
      ...
      <div className="w-full text-sm text-center mt-4 pb-1 ease-in" onClick={(e) => e.currentTarget.blur()}>
        <a href="https://github.com/tansoz/worder" target="_blank" rel="noreferrer">
        ...
        <a href="mailto:rommhui@gmail.com" target="_blank" rel="noreferrer" onClick={(e) => e.currentTarget.blur()}>
